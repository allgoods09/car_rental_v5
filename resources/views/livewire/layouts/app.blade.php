...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: url("{{ asset('images/main-background.png') }}");
            
            /* 2. Add these properties for proper display */
            background-size: cover; /* Stretches image to cover the entire element */
