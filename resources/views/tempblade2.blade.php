...
@section('content')
<div class="max-w-3xl mx-auto bg-white shadow-xl rounded-2xl p-10 mt-20 border border-gray-200 text-center">
    <!-- Success Icon -->
    ...
    <!-- Header -->
    <h2 class="text-3xl font-bold text-gray-800 mb-3">Booking Successful!</h2>
    ...
    <div class="bg-gray-50 rounded-lg p-6 border border-gray-200 mb-8 text-left max-w-md mx-auto">
        ...
        <p class="text-lg font-medium text-gray-800">₱5,400.00</p>
    </div>
