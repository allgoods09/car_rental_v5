...
@section('content')
    <section id="about" class="min-h-screen bg-gray-100 py-20 px-6 flex flex-col justify-center">
        <div class="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-10">
            ...
            <div class="w-full lg:w-1/2 text-center lg:text-left">
                <h3 class="text-4xl font-bold text-gray-800 mb-6">About <span class="text-indigo-600">4A Car Rental</span></h3>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                    <div class="flex items-center gap-4 bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition">
                        ...
                        <p class="text-gray-700 font-semibold">Flexible Rental Plans</p>
                    </div>
                    ...
                    <div class="flex items-center gap-4 bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition">
                        ...
                        <p class="text-gray-700 font-semibold">Top-rated Vehicles</p>
                    </div>
                    ...
                    <div class="flex items-center gap-4 bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition">
                        ...
                        <p class="text-gray-700 font-semibold">Wide Car Selection</p>
                    </div>
                </div>
            </div>
        </div>
